  ...
  <div class="master-rack-chassis">
    ...
    >
      <div class="crs-recessed-panel" style="max-width: 900px; margin: 0 auto;">
        ...
        <p style="margin-bottom: 0.5rem; font-size: 0.9375rem; color: rgba(245,245,245,0.7); font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
          Current supported sites:
        </p>
        <ul style="list-style: none; padding: 0; font-size: 0.9375rem; color: rgba(245,245,245,0.6); font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
    ...
    >
      <div class="crs-recessed-panel" style="max-width: 900px; margin: 0 auto;">
        ...
        <p style="font-size: 0.9375rem; color: rgba(245,245,245,0.85); line-height: 1.6; font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif;">
