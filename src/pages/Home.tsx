  ...
  <>
    ...
    <section class="rack-unit device-rehearsal rack-module">
      ...
      <div class="rack-unit-content">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; flex-direction: column; align-items: center;">
          <a href="https://square.link/u/UQidDzE0?src=embed" target="_blank" rel="noopener noreferrer" class="cta-button cta-button-primary">BOOK REHEARSAL — COWLEY ROAD</a>
    ...
    <section class="rack-unit device-rehearsal-cricket">
      ...
      <div class="rack-unit-content">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; flex-direction: column; align-items: center;">
          <a href="https://square.link/u/WPqRFIGW?src=embed" target="_blank" rel="noopener noreferrer" class="cta-button cta-button-peak-red cta-button-primary">BOOK REHEARSAL — CRICKET ROAD</a>
        </div>
      </div>
    </section>
    ...
    <section class="rack-unit device-control-room">
      ...
      <div class="rack-unit-content">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; flex-direction: column; align-items: center;">
          <a href="https://square.link/u/bCOHXtdl?src=embed" target="_blank" rel="noopener noreferrer" class="cta-button cta-button-primary">BOOK CONTROL ROOM — DRY HIRE</a>
