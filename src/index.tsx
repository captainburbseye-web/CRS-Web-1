      ...
      <head>
        ...
        <style>{`
          * {
          ...
          /* SECONDARY BLOCK - Coming Up (optional) */
          .signage-secondary {
            padding: 1.5rem 0;
          }
          ...
          async function updateSignage() {
            try {
              ...
              if (statusParts.length === 2) {
                statusText.innerHTML = '<span class="status-line-primary">CRS — SYSTEM STATUS</span><span class="status-line-secondary">' + statusParts[0] + ' · ' + statusParts[1] + '</span>';
              } else {
                statusText.innerHTML = '<span class="status-line-primary">CRS — SYSTEM STATUS</span><span class="status-line-secondary">' + statusData.status + '</span>';
              }
      ...
      <body>
        <div class="signage-surface">
          ...
          <div class="signage-header">
            <div class="crs-badge">
              <img src="https://pub-991d8d2677374c528678829280f50c98.r2.dev/crs-images%20website/crs_badge_dark%20fixed%20for%20web.webp" alt="CRS" />
            </div>
          ...
          <div class="signage-block">
            ...
            <div class="service-list" id="services-list">
              ...
              <div class="service-item">
                ...
                <div class="service-label">AV Services</div>
          ...
          {/* SECONDARY BLOCK - COMING UP (hidden if no data) */}
          <div class="signage-secondary" id="schedule-block" style="display: none;">
            <div class="block-label">COMING UP</div>
            <div class="service-list" id="schedule-list">
          ...
          <div class="signage-footer">
            <div>
              <div class="footer-instruction">FOR DETAILS & BOOKING</div>
              <div class="footer-url">cowleyroadstudios.com</div>
            </div>
            <div class="footer-qr">
              <img src="https://pub-991d8d2677374c528678829280f50c98.r2.dev/crs-images%20website/QRcode_c2%20(1).jpg" alt="Scan for booking" />
            </div>
          </div>
        </div>
      </body>
