...
const OSC_PATHS = {
  ...
  /* ═══ CANONICAL DREAMING SPIRES — DO NOT EDIT COORDINATES ═══
     ...
     ═══════════════════════════════════════════════════════════════ */
  /* ═══ CANONICAL DREAMING SPIRES v2 — DO NOT EDIT COORDINATES ═══
     Sharp vertical walls + flat roofs. No smooth curves.
     viewBox="0 0 1000 100", baseline y=90.
     Source: user-supplied geometry 2026-05-02, frozen canonical.
     ═══════════════════════════════════════════════════════════════ */
  SKYLINE: [
       0,  90,   50,  90,   60,  90,   60,  75,   75,  65,   90,  75,
      90,  90,  110,  90,  110,  70,  120,  70,  120,  65,  145,  65,
     145,  70,  155,  70,  155,  90,  180,  90,  180,  60,  200,  20,
     220,  60,  220,  90,  250,  90,  250,  60,  255,  45,  260,  60,
     275,  60,  280,  45,  285,  60,  300,  60,  305,  45,  310,  60,
     310,  90,  340,  90,  340,  55,  360,  55,  375,  35,  390,  55,
     410,  55,  410,  90,  440,  90,  440,  65,  460,  65,  475,  45,
     495,  35,  515,  45,  530,  65,  550,  65,  550,  90,  580,  90,
     580,  60,  600,  35,  620,  60,  620,  90,  650,  90,  650,  50,
     680,  10,  710,  50,  710,  90,  750,  90,  750,  35,  755,  20,
     765,  35,  790,  35,  800,  20,  805,  35,  805,  90,  840,  90,
     840,  60,  845,  45,  850,  60,  870,  60,  875,  45,  880,  60,
     900,  60,  905,  45,  910,  60,  910,  90,  940,  90, 1000,  90,
  ],
...
function CafeHireUnit() {
  ...
  return (
    <div className={`chу chу--${open ? 'open' : 'closed'}`} aria-label="Workshop Café & Venue">
      ...
      {/* ── FASCIA — high-res rack image + invisible click overlay ─── */}
      <div className="chу-fascia-img-wrap">

        {/* The render — fills full width, rail to rail */}
        <img
          src="/static/workshop-cafe-rack.png"
          alt="Workshop Café rack unit"
          className="chу-fascia-img"
          draggable="false"
        />

        {/* Power LED — sits over the green LED in the render (bottom-right) */}
        <span
          className={`chу-power-led-overlay${open ? ' chу-power-led--on' : ''}`}
          aria-hidden="true"
        />

        {/* Invisible full-fascia click target — opens the drawer */}
        <button
          className="chу-fascia-click"
          aria-expanded={open}
          aria-controls="cafe-hire-drawer"
          aria-label="Workshop Café — open menu"
