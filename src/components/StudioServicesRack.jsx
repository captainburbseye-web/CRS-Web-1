    ...
    <>
      <div className="flex items-center gap-1.5 sm:gap-3 min-w-0">
        ...
        <div className="flex flex-col min-w-0 text-left">
          <span className="font-mono font-bold tracking-wide sm:tracking-widest uppercase text-[10px] sm:text-base leading-tight drop-shadow-md truncate">
            {serviceName}
          </span>
          {locationName && (
            <span className="font-mono text-[8px] sm:text-xs uppercase tracking-wide sm:tracking-[0.2em] opacity-80 truncate">
              {locationName}
            </span>
          )}
        </div>
